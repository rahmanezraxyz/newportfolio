...
export default function ProjectPreview({ modal, projects }: ProjectModalProps) {
  ...
  return (
    <>
      <motion.div
        className="pointer-events-none absolute flex h-[170px] w-[400px] items-center justify-center overflow-hidden rounded-xl bg-white"
        ref={modalContainer}
      ...
      <motion.div
        className="font-base bg-primary-500 pointer-events-none absolute z-10 flex h-16 w-16 items-center justify-center rounded-full font-light text-white"
        ref={cursor}
        variants={scaleAnimation}
        initial="initial"
        animate={active ? "enter" : "closed"}
